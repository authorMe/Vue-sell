<template>
    <div id="goods" class="goods poAbs">
                        ...
                        <li v-for="food in item.foods" class="food-item">
                            ...
                            <div class="content">
                                ...
                                <div class="price">
                                    ...
                                    <span v-show="food.oldPrcie" class="old">￥{{food.oldPrcie}}</span>
                                </div>
                            </div>
                        </li>
                    </ul>
...
<style>
    .goods{display:flex;width:100%;overflow:hidden;top:147px;bottom:46px;}
    .menu-wrapper{flex:0 0 80px;width:80px;background:#f3f5f7;}
    .menu-wrapper .menu-item{display:table;width:56px;height:54px;line-height:14px;padding:0 12px;}
    .menu-wrapper .menu-item .text{display:table-cell;font-size:12px;width:56px;vertical-align:middle;border-bottom:1px solid rgba(7,17,27,0.1);}
    .foods-wrapper{flex:1;background: #fff;}
    ...
    .food-item{display:flex;margin:18px;border-bottom:1px solid rgba(7,17,27,0.1);}
    .food-item:last-child{border:0;margin-bottom:0;}
    .food-item .icon{flex:0 0 57px;margin-right:10px;}
    .food-item .content{flex:1;}
    .food-item .content .name{margin:2px 0 8px 0;hieght:14px;line-height:14px;font-size:14px;color:rgb(7,17,27);}
    .food-item .content .desc,.food-item .content .extra{line-height:10px;font-size:10px;color:rgb(147,153,159);}
    .food-item .content .desc{margin-bottom:8px;}
